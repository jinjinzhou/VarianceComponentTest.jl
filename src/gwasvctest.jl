...
function gwasvctest(args...; covFile::String = "", device::String = "CPU",
  ...
  if !flagAnnotate
    ...
    outresults = pmap(loopwinFixsize,
                      ...
                      [snpWtType for i = 1:ncores],
                      [keepIdx for i = 1:ncores],
                      [nPerKeep for i = 1:ncores],
                      [kernel for i = 1:ncores],
                      [kinship for i = 1:ncores],
                      [test for i = 1:ncores],
                      [XtNullBasis for i = 1:ncores],
                      [WPreSim for i = 1:ncores],
                      [nBlockAscent for i = 1:ncores],
                      [nMMmax for i = 1:ncores],
                      [nNullSimPts for i = 1:ncores],
                      [tolX for i = 1:ncores],
                      [pvalueComputing for i = 1:ncores],
                      [device for i = 1:ncores],
                      [nNullSimNewtonIter for i = 1:ncores],
                      [rankQPhi for i = 1:ncores],
                      [evalPhiAdj for i = 1:ncores],
                      [XPhitNullBasis for i = 1:ncores],
                      [yShift for i = 1:ncores],
                      [y for i = 1:ncores],
                      [KPhiAdj for i = 1:ncores],
                      [weightedW for i = 1:ncores],
                      [QPhi for i = 1:ncores],
                      [PrePartialSumW for i = 1:ncores],
                      [PreTotalSumW for i = 1:ncores],
                      [windowSize for i = 1:ncores],
                      [nPreRank for i = 1:ncores],
                      [X for i = 1:ncores],
                      [ynew for i = 1:ncores]);
